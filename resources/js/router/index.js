...
let _routers = [
            ...
            {
                name: 'list_service_plan_registrations',
                path: '/service/plan-registrations',
                component: _import('servicePlanRegistration/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            ...
            },
            {
                name: 'listWhyChoose',
                path: '/why-choose',
                component: _import('whyChoose/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'addWhyChoose',
                path: '/why-choose/add',
                component: _import('whyChoose/add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                component: _import('whyChoose/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/process-step',
                component: _import('processStep/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'addProcessStep',
                path: '/process-step/add',
                component: _import('processStep/add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/process-step/edit/:id',
                component: _import('processStep/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'listIntegrationLogo',
                path: '/integration-logo',
                component: _import('integrationLogo/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'addIntegrationLogo',
                path: '/integration-logo/add',
                component: _import('integrationLogo/add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                path: '/integration-logo/edit/:id',
                component: _import('integrationLogo/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
...
function inferRequiredPermission(path) {
    ...
    if (path.startsWith('/why-choose')) return 'whychoose.view';
    if (path.startsWith('/process-step')) return 'processstep.view';
    if (path.startsWith('/integration-logo')) return 'integrationlogo.view';
