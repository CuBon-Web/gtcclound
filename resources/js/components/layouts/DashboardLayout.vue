  ...
  data() {
    return {
      ...
      objSidebar: [
        ...
        {
          icon: "mdi mdi-star-circle menu-icon",
          name: "Vì sao chọn chúng tôi",
          route_name: "",
          sub: [
            {
              name: "Danh sách",
        ...
        {
          icon: "mdi mdi-timeline-check-outline menu-icon",
        ...
        {
          icon: "mdi mdi-puzzle menu-icon",
          name: "Logo đối tác tích hợp",
          route_name: "",
          sub: [
            {
              name: "Danh sách",
