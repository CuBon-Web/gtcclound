...
class RbacPermissions
{
    ...
    public static function all()
    {
        ...
        self::crudPermissions('whychoose', 'lý do chọn chúng tôi'),
        self::crudPermissions('processstep', 'quy trình làm việc'),
        self::crudPermissions('integrationlogo', 'logo đối tác tích hợp'));
    }
}
