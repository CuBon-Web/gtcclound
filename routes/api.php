...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'service','namspace'=>"service"], function(){
		...
		Route::post('plan-registrations/list','ServicePlanRegistrationController@list')->middleware('rbac.permission:service.view');
		Route::get('plan-registrations/delete/{id}','ServicePlanRegistrationController@delete')->middleware('rbac.permission:service.delete');
	});
	...
	Route::group(['prefix'=>'why-choose-us'], function(){
		Route::post('list','WhyChooseUsController@list')->middleware('rbac.permission:whychoose.view');
		Route::post('create','WhyChooseUsController@create')->middleware('rbac.permission:whychoose.create');
		Route::get('edit/{id}','WhyChooseUsController@edit')->middleware('rbac.permission:whychoose.view');
		Route::get('delete/{id}','WhyChooseUsController@delete')->middleware('rbac.permission:whychoose.delete');
	});
	Route::group(['prefix'=>'process-step'], function(){
		Route::post('list','ProcessStepController@list')->middleware('rbac.permission:processstep.view');
		Route::post('create','ProcessStepController@create')->middleware('rbac.permission:processstep.create');
		Route::get('edit/{id}','ProcessStepController@edit')->middleware('rbac.permission:processstep.view');
		Route::get('delete/{id}','ProcessStepController@delete')->middleware('rbac.permission:processstep.delete');
	});
	Route::group(['prefix'=>'integration-logo'], function(){
		Route::post('list','IntegrationLogoController@list')->middleware('rbac.permission:integrationlogo.view');
		Route::post('create','IntegrationLogoController@create')->middleware('rbac.permission:integrationlogo.create');
		Route::get('edit/{id}','IntegrationLogoController@edit')->middleware('rbac.permission:integrationlogo.view');
		Route::get('delete/{id}','IntegrationLogoController@delete')->middleware('rbac.permission:integrationlogo.delete');
	});
