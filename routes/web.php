...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('dich-vu/{slug}/san-pham.json','PageController@serviceLinkedProductsJson')->name('serviceLinkedProductsJson');
    Route::post('dich-vu/dang-ky-goi','PageController@postServicePlanRegister')->name('postServicePlanRegister');
